...
def _submit_user_message(sess, user_input: str, *, speak_reply: bool = False) -> None:
    """Process one chat turn (shared by text form and voice input)."""
    ...
    tutor_text = output["tutor_response"]
    ...
    if speak_reply and tutor_text and not is_error:
        try:
        ...
        if st.session_state.messages:
            ...
            if st.button("💾 Save Log"):
                try:
                    ...
                    sess.save_log(conversation=conv)
